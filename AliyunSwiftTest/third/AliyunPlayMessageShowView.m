...
@interface AliyunPlayMessageShowView()

@property (nonatomic, strong)UIView* contentView;
@property (nonatomic, strong)UIButton * leftButton;
@property (nonatomic, strong)UIButton * hiddenButton;
@end
@implementation AliyunPlayMessageShowView
...
- (UIButton *)leftButton{
    if (!_leftButton) {
        ...
        [_leftButton setTitle:NSLocalizedString(@"clear_message", nil) forState:UIControlStateNormal];
...
- (UIButton *)hiddenButton{
    if (!_hiddenButton) {
        ...
        [_hiddenButton setTitle:NSLocalizedString(@"clicked_ok", nil) forState:UIControlStateNormal];
